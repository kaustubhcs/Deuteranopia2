...
public class KNearest extends StatModel {
    ...
    //
    // C++:  float findNearest(Mat research, int k, Mat& results, Mat& neighborResponses = Mat(), Mat& dist = Mat())
    //

    //javadoc: KNearest::findNearest(research, k, results, neighborResponses, dist)
    ...
    //javadoc: KNearest::findNearest(research, k, results)
