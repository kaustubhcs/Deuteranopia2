...
public class EM extends StatModel {
    ...
    //
    // C++:  bool trainEM(Mat research, Mat& logLikelihoods = Mat(), Mat& labels = Mat(), Mat& probs = Mat())
    //

    //javadoc: EM::trainEM(research, logLikelihoods, labels, probs)
    ...
    //
    // C++:  bool trainE(Mat research, Mat means0, Mat covs0 = Mat(), Mat weights0 = Mat(), Mat& logLikelihoods = Mat(), Mat& labels = Mat(), Mat& probs = Mat())
    //

    //javadoc: EM::trainE(research, means0, covs0, weights0, logLikelihoods, labels, probs)
    ...
    //javadoc: EM::trainE(research, means0)
    ...
    //
    // C++:  bool trainM(Mat research, Mat probs0, Mat& logLikelihoods = Mat(), Mat& labels = Mat(), Mat& probs = Mat())
    //

    //javadoc: EM::trainM(research, probs0, logLikelihoods, labels, probs)
    ...
    //javadoc: EM::trainM(research, probs0)
