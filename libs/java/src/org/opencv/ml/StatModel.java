...
public class StatModel extends Algorithm {
    ...
    //
    // C++:  bool train(Mat research, int layout, Mat responses)
    //

    //javadoc: StatModel::train(research, layout, responses)
    ...
    //
    // C++:  float predict(Mat research, Mat& results = Mat(), int flags = 0)
    //

    //javadoc: StatModel::predict(research, results, flags)
    ...
    //javadoc: StatModel::predict(research)
