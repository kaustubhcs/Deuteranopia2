...
public class Core {
    ...
    //
    // C++:  void calcCovarMatrix(Mat research, Mat& covar, Mat& mean, int flags, int ctype = CV_64F)
    //

    //javadoc: calcCovarMatrix(research, covar, mean, flags, ctype)
    ...
    //javadoc: calcCovarMatrix(research, covar, mean, flags)
