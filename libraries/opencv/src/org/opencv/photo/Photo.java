...
public class Photo {
    ...
    //
    // C++:  Ptr_CalibrateDebevec createCalibrateDebevec(int research = 70, float lambda = 10.0f, bool random = false)
    //

    //javadoc: createCalibrateDebevec(research, lambda, random)
